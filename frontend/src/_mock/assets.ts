...
const DASHBOARD_PERMISSION = {
	...
	children: [
		...
		},
		{
			id: "9710971640510357",
			parentId: "9100714781927703",
			label: "sys.nav.purchase-tracker",
		...
		},
		{
			id: "9710971640510358",
			parentId: "9100714781927703",
			label: "sys.nav.asin-bank",
			name: "ASIN Bank",
			type: PermissionType.MENU,
			route: "asin-bank",
			component: "/dashboard/asin-bank/index.tsx",
		},
		{
			id: "9710971640510359",
			parentId: "9100714781927703",
			label: "sys.nav.retailers",
			name: "Retailers",
			type: PermissionType.MENU,
			route: "retailers",
			component: "/dashboard/retailers/index.tsx",
		},
		{
			id: "9710971640510360",
			parentId: "9100714781927703",
			label: "sys.nav.checkin",
			name: "Check In",
			type: PermissionType.MENU,
			route: "checkin",
			component: "/dashboard/checkin/index.tsx",
		},
	],
};
